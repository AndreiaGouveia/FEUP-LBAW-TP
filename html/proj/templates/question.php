...
?>
    ...
    <button type="radio" class="btn like" id="thumbs-up" name="votes">
        <i class="far fa-thumbs-up"></i></button>
    <label for="thumbs-up">17</label>

    <button type="radio" class="btn like" id="thumbs-down" name="votes">
        <i class="far fa-thumbs-down"></i></button>
    <label for="thumbs-down">7</label>

    <p class="author float-right">Filipa S.</p>

    <button class="btn favorites" id="favorites">
