...
?>
    ...
    <a class="btn btn-secondary btn-sm px-2 py-0 my-1" href="../pages/searchTopic.php?search=<?=$topic?>"><?= $topic ?></a>
...
?>
    <div class="py-3 px-4 border-top">
        <a class="btn btn-secondary" href="../pages/searchTopic.php?search=<?=$topic?>"><?= $topic ?></a>
    </div>
