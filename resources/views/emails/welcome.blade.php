@component('mail::layout')
    ...
    @slot('header')
        ...
        <a class="navbar-brand px-2 mr-5" href="{{ url('home') }}">
            <img src="https://i.ibb.co/FB6qj03/logo.png"  width="35" height="42" class="d-inline-block align-center" alt="logo" /></a>
            Papagaio
        </a>
    ...
    <header class="welcome ">
            ...
            <img src="https://i.ibb.co/FB6qj03/logo.png" alt="logo" /></a>
