...
<div id="header-card mb-3">
    <a href="{{ route('members', $idMember) }}"><img src=<?= $link ?> class="img_inside mr-2" alt=""></a>
    <div class="header-text">
    <a href="{{ route('members', $idMember) }}"><p class="name-and-action font-weight-bold d-inline"><?= $name ?></p></a>
