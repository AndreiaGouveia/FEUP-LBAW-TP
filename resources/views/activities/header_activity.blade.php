<?php
$link = (isset($link_profile) && !$anonymous) ? $link_profile : "images/default.png";
?>

<div class="header-card mb-3">
    <a @if(!$anonymous) href="{{ route('members', $memberId) }}" @endif><img src='{{asset("storage/$link")}}' class="img_inside mr-2" alt=""></a>
